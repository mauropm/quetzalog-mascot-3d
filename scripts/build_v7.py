"""Quetzalog mascot - seventh pass (v7): structural refinement.
...
def build_head():
    ...
    # snout
    loft([(52.0, 6.5, 7.1, -28.5), (55.5, 7.3, 7.8, -30.5),
          (60.5, 7.3, 7.8, -31.5), (64.5, 6.1, 6.5, -30.5),
          (66.5, 3.9, 4.1, -29.0)], n=32, power=2.6, name="snout")
    reg(76, "Body_Teal", t_ellip((0, -30, 60), (8.6, 9.4, 8.6)))
    # cream cheeks + jaw
    for sx in (-1, 1):
    ...
    # nostrils
    for sx in (-1, 1):
        add_ellipsoid((sx * 3.5, -38.0, 61.8), (1.3, 1.7, 1.3), col=DETAIL,
                      name="nostril")
        reg(95, "Eye_Pupil", t_ellip((sx * 3.5, -38.1, 61.8), (1.7, 2.1, 1.7)))
    # red forehead crest
...
def build_legs():
    for sx in (-1, 1):
        ...
        loft([(0.0, 6.6, 8.0, 0.0), (5.0, 7.4, 9.0, 0.0),
              (12.0, 7.6, 9.2, 0.0), (22.0, 7.4, 9.0, -0.3),
              (30.0, 7.2, 8.8, -0.9), (35.0, 6.7, 8.5, -1.5),
              (38.5, 5.7, 7.6, -2.1), (40.8, 3.9, 5.6, -2.7)],
             n=28, power=2.8, name="fleg", loc=(sx * 10.5, -12.0, 0))
        add_ellipsoid((sx * 10.0, -11.0, 34.5), (8.6, 10.0, 8.8),
                      name="shoulder")
        ...
        loft([(6.0, 8.4, 10.0, 0.0), (12.0, 9.2, 11.0, 0.0),
              (19.0, 9.0, 10.6, 0.0), (25.0, 8.1, 9.7, 0.0),
              (30.0, 6.9, 8.3, 0.0), (34.5, 4.8, 5.8, 0.0)],
             n=28, power=2.8, name="bleg", loc=(sx * 14.5, 15.0, 0))
        add_ellipsoid((sx * 13.5, 14.0, 24.5), (9.6, 10.6, 10.0),
                      name="hip")
...
def main():
    ...
    bpy.ops.wm.save_as_mainfile(filepath=os.path.join(OUT, "quetzalog_v7.blend"))
