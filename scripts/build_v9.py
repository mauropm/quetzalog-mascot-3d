...
def build_head():
    ...
    # snout
    # ONE snout volume: the lower section is the jaw, so the cream muzzle can
    # never read as a separate ball parked behind the snout
    loft([(47.0, 6.2, 6.6, -27.0), (51.0, 7.2, 7.8, -30.5),
          (55.5, 7.9, 8.5, -32.8), (60.0, 7.9, 8.5, -33.6),
          (64.5, 6.7, 7.1, -32.2), (67.0, 4.3, 4.5, -30.2)],
         n=32, power=2.6, name="snout")
    reg(76, "Body_Teal", t_ellip((0, -32, 60.5), (8.8, 9.8, 9.0)))
    ...
    reg(74, "Cream", t_ellip((0, -33.0, 53.5), (9.4, 11.0, 6.6)))
    # throat: fills the notch between the jaw overhang and the neck
    add_ellipsoid((0, -22.5, 50.5), (8.0, 7.0, 6.0), name="throat")
    # nostrils
    for sx in (-1, 1):
...
def main():
    ...
    bpy.ops.wm.save_as_mainfile(filepath=os.path.join(OUT, "quetzalog_v9.blend"))
