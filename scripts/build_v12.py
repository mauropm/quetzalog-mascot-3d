...
def build_body():
    ...
    reg(60, "Cream", t_ellip((0, -13.5, 26), (10.0, 10.0, 18.5)))
...
def build_head():
    ...
    loft([(47.0, 6.2, 6.6, -27.5), (51.0, 7.3, 7.9, -31.0),
          (55.5, 8.0, 8.6, -33.5), (60.0, 8.0, 8.6, -34.3),
          (64.5, 6.8, 7.2, -33.0), (67.0, 4.4, 4.6, -30.5)],
    ...
    reg(74, "Cream", t_ellip((0, -34.5, 53.5), (9.6, 12.0, 7.2)))
    # throat: fills the notch between the jaw overhang and the neck.  It is the
    # frontmost surface in a band just under the jaw, so it needs its own cream
    # region - otherwise it reads as a green stripe across the underside.
    add_ellipsoid((0, -22.5, 50.5), (8.0, 7.0, 6.0), name="throat")
    reg(63, "Cream", t_ellip((0, -24.0, 48.0), (7.5, 8.5, 6.5)))
...
def main():
    ...
    bpy.ops.wm.save_as_mainfile(filepath=os.path.join(OUT, "quetzalog_v12.blend"))
