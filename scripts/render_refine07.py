"""Diagnostics for the tail/back integration + yellow underside pass."""
import bpy, os
from mathutils import Vector

PROJ = "/Users/mauro/Documents/Code/3D-Quetzalog"
OUT = os.path.join(PROJ, "output", "refinement07")
...
SHOTS = [
    ...
    ("left",         'ORTHO', Vector((D, 12, 50)),       Vector((0, 12, 50)), 150),
    ("right",        'ORTHO', Vector((-D, 12, 50)),      Vector((0, 12, 50)), 150),
    ("top",          'ORTHO', Vector((0, 12, D)),        Vector((0, 12, 50)), 150),
    ("front_3quarter", 'PERSP', Vector((-300, -330, 200)), Vector((0, 8, 48)), 0),
    ("back_3quarter",  'PERSP', Vector((300, 330, 200)),   Vector((0, 12, 48)), 0),
    ("rear_low",       'PERSP', Vector((150, 330, 90)),    Vector((0, 18, 34)), 0),
    ("tail_join",      'PERSP', Vector((230, 300, 130)),   Vector((0, 16, 40)), 0),
    ("neck_front",     'PERSP', Vector((-120, -260, 120)), Vector((0, -14, 52)), 0),
]
