...
def build_head():
    ...
    reg(76, "Body_Teal", t_ellip((0, -33.5, 60.5), (9.2, 12.5, 7.0)))
    ...
    for sx in (-1, 1):
        ...
        reg(72, "Cream", t_ellip((sx * 8.4, -28.5, 62.5), (8.2, 9.6, 8.0)))
    ...
    reg(74, "Cream", t_ellip((0, -34.5, 54.5), (9.6, 12.0, 9.0)))
    ...
    reg(63, "Cream", t_capsule((0, -14.0, 43.0), (0, -31.0, 53.5), 8.2))
    # nostrils: tall ovals on the nose block's front face
    for sx in (-1, 1):
        reg(95, "Eye_Pupil", t_ellip((sx * 3.5, -43.4, 62.0), (1.6, 2.2, 2.4)))
    # red forehead crest
...
def main():
    ...
    bpy.ops.wm.save_as_mainfile(filepath=os.path.join(OUT, "quetzalog_v15.blend"))
