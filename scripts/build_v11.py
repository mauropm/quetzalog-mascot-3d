...
def build_body():
    ...
    reg(62, "Cream", t_capsule((0, -19.0, 44.0), (0, -18.5, 58.0), 5.9))
...
def build_head():
    ...
    reg(74, "Cream", t_ellip((0, -34.5, 53.5), (9.4, 11.6, 6.6)))
...
def main():
    ...
    bpy.ops.wm.save_as_mainfile(filepath=os.path.join(OUT, "quetzalog_v11.blend"))
